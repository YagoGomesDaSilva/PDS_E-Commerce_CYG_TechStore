...
/*
    public Estoque updateEstoque(Long anuncianteId, Produto produto, int quantidade) {
        Optional<Anunciante> anuncianteOpc = anuncianteRepository.findAnuncianteByIdWithDetails(anuncianteId);
        Anunciante anunciante = anuncianteOpc.orElseThrow(() -> new UsuarioExCustom(UsuarioEnumEx.USUARIO_NAO_ENCONTRADO));
    ...
    public Estoque createEstoque(Long anuncianteId, Produto produto){
    ...
    public Estoque deleteEstoque(Long anuncianteId, Produto produto){
        Optional<Anunciante> anuncianteOpc = anuncianteRepository.findAnuncianteByIdWithDetails(anuncianteId);
        Anunciante anunciante = anuncianteOpc.orElseThrow(() -> new UsuarioExCustom(UsuarioEnumEx.USUARIO_NAO_ENCONTRADO));
    ...
    public Estoque findEstoque(Long anuncianteId, Produto produto){
        Optional<Anunciante> anuncianteOpc = anuncianteRepository.findAnuncianteByIdWithDetails(anuncianteId);
        Anunciante anunciante = anuncianteOpc.orElseThrow(() -> new UsuarioExCustom(UsuarioEnumEx.USUARIO_NAO_ENCONTRADO));
